    ...
    <main className="pt-16">
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              <img src={aboutTeam} alt="PSS students" className="rounded-2xl shadow-primary w-full object-cover h-80 lg:h-96" />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-4xl text-primary mb-3">
              {isKh ? "គុណតម្លៃស្នូល" : "Core Values"}
            </h2>
          </div>
      ...
      <section className="py-20 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="font-display font-bold text-3xl md:text-4xl text-primary mb-3">
              {isKh ? "ប្រវត្តិសាស្ត្រ" : "Our Journey"}
            </h2>
            <p className="text-muted-foreground">{isKh ? "ពី PNC ដល់ PSS — ២០ ឆ្នាំ" : "From PNC to PSS — 20 years of transforming lives"}</p>
          </div>
